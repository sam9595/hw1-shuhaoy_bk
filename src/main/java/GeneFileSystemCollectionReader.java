 ...
 * 
 */
public class GeneFileSystemCollectionReader extends CollectionReader_ImplBase {
  /**
  ...
  public void initialize() throws ResourceInitializationException {
    ...
    //I add the function that the filepath can be a file instead of a directory
